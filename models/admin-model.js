...
module.exports = {
	...
	validate: function (user, callback) {
		var sql = "SELECT * FROM admininfo where uname=? and password=?";
	...
	getByUname: function (username, callback) {
		var sql = "select * from admininfo where uname=?";
	...
	insert: function (user, callback) {
		...
		db.execute(sql, [user.id, user.username, user.email, user.password, user.bloodgroup,  user.phonenumber,user.dept,user.type,], function (status) {
			if (status) {
			//	console.log(user);
				callback(true);
			} else {
